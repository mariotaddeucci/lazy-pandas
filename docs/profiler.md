...
└── ▼ 📂 18.993GB (100.00 %) <module>  benckmark.py:35
    └── ▼ 📂 18.993GB (100.00 %) with_pandas  benckmark.py:11
...
┡━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ with_pandas at ./benckmark.py                                                    │       18.993GB │        100.00% │    1.572KB │        0.00% │        8590 │
│ <module> at ./benckmark.py                                                       │       18.993GB │        100.00% │     0.000B │        0.00% │        8590 │
...
```bash
▼ 📂 3.137GB (100.00 %) <ROOT>
└── ▼ 📂 526.513MB (16.39 %) <module>  benckmark.py:37
    ├── ▼ 📂 525.916MB (16.37 %) with_pandas_lazy  benckmark.py:27
    │   └── 📄 525.916MB (16.37 %) collect  pandas_lazy/frame.py:41
    ├── ▶ 📂 595.623KB (0.02 %) with_pandas_lazy  benckmark.py:22
    ├── ▶ 📂 8.219KB (0.00 %) with_pandas_lazy  benckmark.py:26
    ├── ▶ 📂 3.727KB (0.00 %) with_pandas_lazy  benckmark.py:24
    ├── ▶ 📂 3.133KB (0.00 %) with_pandas_lazy  benckmark.py:25
    └── ▶ 📂 392.000B (0.00 %) with_pandas_lazy  benckmark.py:23

┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
│ Location                                     │ <Total Memory> │ Total Memory % │ Own Memory │ Own Memory % │ Alloc.Count │
│━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ ??? at ???                                   │        2.622GB │         83.61% │    2.622GB │       83.61% │       50427 │
│ with_pandas_lazy at ./benckmark.py           │      526.513MB │         16.39% │   520.000B │        0.00% │        7156 │
│ <module> at ./benckmark.py                   │      526.513MB │         16.39% │     0.000B │        0.00% │        7156 │
