"""
Reader functions for various data formats.

This module provides functions to read data from different sources and formats
(CSV, JSON, Parquet, Delta Lake, Iceberg) into LazyFrame objects.
"""
...
def read_delta(path: str, *, conn: duckdb.DuckDBPyConnection | None = None) -> LazyFrame:
    ...
    Args:
        ...
        conn (duckdb.DuckDBPyConnection | None): Optional DuckDB connection to use.
